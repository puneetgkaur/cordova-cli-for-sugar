...
SocialCalc.SpreadsheetControl = function() {
   ...
   this.tabs.push({name: "edit", text: "Edit", html:
      ' <div id="%id.edittools" style="padding:4px 4px 4px 4px;">'+
...
'<br>'
   ...
   this.tabs.push({name: "sort", text: "Sort", html:
	   ' <div id="%id.sorttools" style="display:none;">'+
	      '  <table cellspacing="0" cellpadding="0"><tr>'+
	      '   <td style="vertical-align:top;padding-right:0px;width:20px;">'+
	      ...
	      '   </td>'+
	      '   <td style="vertical-align:middle;padding-right:0px;width:20px;text-align:left;">'+
	      '    <div style="%tbt.">&nbsp;</div>'+
   ...
   this.tabs.push({name: "audit", text: "Audit", html:
      ...
      onclick:
         function(s, t) {
            ...
            var i, j;
            var str = '<table cellspacing="0" cellpadding="0" style="margin-bottom:10px;"><tr><td style="font-size:small;padding:2px;"><b>'+SCLoc("Audit Trail This Session")+':</b><br><br>';
   ...
   this.tabs.push({name: "comment", text: "Comment", html:
      ...
      '<textarea id="%id.commenttext" style="font-size:small;height:20px;width:300px;overflow:auto;" onfocus="%s.CmdGotFocus(this);"></textarea>'+
   ...
   this.tabs.push({name: "names", text: "Names", html:
      ...
      '    <input type="text" id="%id.namesname" style="font-size:x-small;width:50px;" onfocus="%s.CmdGotFocus(this);">'+
      '   </td>'+
      '   <td style="vertical-align:top;padding-right:6px;">'+
      '    <div style="%tbt.">%loc!Description!</div>'+
      '    <input type="text" id="%id.namesdesc" style="font-size:x-small;width:75px;" onfocus="%s.CmdGotFocus(this);">'+
      '   </td>'+
      '   <td style="vertical-align:top;padding-right:6px;">'+
      '    <div style="%tbt.">%loc!Value!</div>'+
      '    <input type="text" id="%id.namesvalue" width="13" style="font-size:x-small;width:80px;" onfocus="%s.CmdGotFocus(this);">'+
      '   </td>'+
  ...
  // Graphing added as on 10.1.11
   this.tabnums.graph = this.tabs.length;
   this.tabs.push({name: "graph", text: "Graph", html:
   ...
   this.views["graph"] = {name: "graph", divStyle: "overflow:auto;", values: {},
      html: '<div style="padding:6px;">Graph View</div>'
      };

   this.editor.SettingsCallbacks.graph = {save: GraphSave, load: GraphLoad};
...
SocialCalc.InitializeSpreadsheetControl = function(spreadsheet, node, height, width, spacebelow) {
   ...
   html = '<div><div style="'+spreadsheet.toolbarbackground+'padding:0px 40px 25px 20px;height:40px;">';
...
spreadsheet.Buttons = {
   ...
   spreadsheet.formulabarDiv.innerHTML = '<input type="text" size="45" value="">&nbsp;'; //'<textarea rows="4" cols="60" style="z-index:5;background-color:white;position:relative;"></textarea>&nbsp;';
   ...
   for (button in spreadsheet.formulabuttons) {
      ...
      bele.style.border = "0px solid #FFF";
      bele.style.marginLeft = "8px";
...
SocialCalc.DoOnResize = function(spreadsheet) {
   ...
   spreadsheet.editor.ResizeTableEditor(spreadsheet.width-50, spreadsheet.height-spreadsheet.nonviewheight);
